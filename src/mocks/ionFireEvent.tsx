// Borrowed from
// https://github.com/ionic-team/ionic-react-test-utils/blob/a64da16b37f46fb7614696e21e942f88845c6198/src/ionFireEvent.ts
...
function ionScrollStart(element: Document | Element | Window) {
  fireEvent(
    element,
    new CustomEvent("ionScrollStart", {
      detail: {
        isScrolling: true,
      },
    })
